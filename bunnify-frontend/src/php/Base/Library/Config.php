 ...
 *
 * File Path: src/php/Base/Library/Config.php
 *
...
class Config {
	 ...
	 *
	 * @var \BunnifyFrontend\Base\Main\Application
	 */
	protected $app;
	 ...
	 *
	 * @param \BunnifyFrontend\Base\Main\Application $app Application instance this config is for.
	 */
	public function __construct( \BunnifyFrontend\Base\Main\Application $app ) {
