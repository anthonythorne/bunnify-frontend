...
| 4 | [Core Web Vitals image delivery](cwv-image-delivery/README.md) | 2 | **Declined** | Built then reverted — WordPress 7.0 core already emits width/height + `fetchpriority`; CWV is the developer/theme's responsibility, not a URL-rewriter's. |
